        ...
        <div class="container-fluid h-100">
            <div class="row h-100">
                <div class="col-12 h-100 px-0">
                    ...
                    <img src="<?php echo get_field('home_hero_image', $post->ID)['url'] ?>" alt="">
                </div>
                <div class="col-12 pl-md-80 pl-lg-150 text-float">
                    ...
                    <div class="d-flex flex-column flex-md-row mt-30">
                        <a href="" class="btn btn-light mr-md-15 mb-15 mb-md-0 ">Conoce umbra</a>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 col-lg-6 px-0">
                    <img class="w-100 h-100" src="img/building-1.jpg" alt="Umbra Building">
                </div>
            </div>
            <div class="row flex-column-reverse flex-lg-row">
                <div class="col-12 col-lg-6 px-0">
                    <img class="w-100 h-100" src="img/building-back.jpg" alt="Umbra Building">
                </div>
                <div
                ...
                <div class="col-12 col-lg-9">
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="black" role="tabpanel" aria-labelledby="black-tab">
                            <div class="row justify-content-between">
                                <div class="col-12 col-md-7">
                                    <img src="img/model-black.png" alt="Model Black">
                                </div>
                        ...
                        <div class="tab-pane fade" id="grey" role="tabpanel" aria-labelledby="grey-tab">
                            <div class="row justify-content-between">
                                <div class="col-12 col-md-7">
                                    <img src="img/model-grey.png" alt="Model Black">
                                </div>
                                <div class="col-12 col-md-4 d-flex flex-column justify-content-center">
                                    <h1 class="pb-15 pt-15 pt-md-0">Caractéristicas</h1>
                                    <ul class="nav flex-md-column">
                        ...
                        <div class="tab-pane fade" id="white" role="tabpanel" aria-labelledby="white-tab">
                            <div class="row justify-content-between">
                                <div class="col-12 col-md-7">
                                    <img src="img/model-white.png" alt="Model Black">
                                </div>
                                <div class="col-12 col-md-4 d-flex flex-column justify-content-center">
                                    <h1 class="pb-15 pt-15 pt-md-0">Caractéristicas</h1>
                                    <ul class="nav flex-md-column">
            ...
            <div class="row flex-column-reverse flex-lg-row">
                <div class="col-12 col-lg-6 px-0">
                    <a href="https://goo.gl/maps/gkx6K85rHKF2wwaF7" target="_blank">
                        <img class="w-100 h-100" src="img/mapa.jpg" alt="Umbra Building">
                    </a>
                </div>
                <div
    ...
    <section id="contacto">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 col-lg-6 px-0">
                    <img src="img/building-side.jpg" alt="">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="d-flex justify-content-center mb-15">
                        <canvas style="height:128px;width:128px" height="128" width="128" class="qr-code"></canvas>
                    </div>
                    <div class="d-flex justify-content-center mb-15">
